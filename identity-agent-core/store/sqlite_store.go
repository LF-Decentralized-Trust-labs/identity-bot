...
//
// One definition, because a second would drift and the failure is silent: a
// pool allocated from one base and read from another finds nothing, and reports
// an identity as belonging to somebody else rather than as missing.
//
...
// for unrelated relationships. Observed rather than theorised: adding the
// machines pool without a base immediately minted an identifier identical to
// one already in use. A new pool is a deliberate decision about a range, and it
// is made here.
